...
Olá! Seja bem vindo(a) ao meu projeto de infraestrutura como código na AWS. Esse projeto foi desenvolvido a partir do projeto original, acrescentando o método de exclusão.
